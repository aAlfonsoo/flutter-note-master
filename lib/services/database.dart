  ...
  Future<bool> createNewUser(UserModel user) async {
    try {
      await _firestore
          ...
          .doc(user.id)
          .set({"id": user.id, " firstname": user.firstname, " lastname": user.lastname, " birthdate": user.birthdate, "username": user.username,"email": user.email, "password": user.password, "confirmpassword": user.confirmpassword});
      return true;
    } catch (e) {
      print(e);
      return true;
